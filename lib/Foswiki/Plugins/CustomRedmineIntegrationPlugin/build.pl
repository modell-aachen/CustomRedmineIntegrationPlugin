...
package CustomRedmineIntegrationPluginBuild;
use Foswiki::Contrib::Build;
our @ISA = qw( Foswiki::Contrib::Build );

sub new {
    my $class = shift;
    return bless( $class->SUPER::new("CustomRedmineIntegrationPlugin"), $class );
}
...
my $build = new CustomRedmineIntegrationPluginBuild();
